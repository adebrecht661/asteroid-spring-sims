...
void write_surf_part(reb_simulation *const n_body_sim, int i_low, int i_high, bool is_surf,
		string filename);
...
void write_resolved_with_E(reb_simulation *const n_body_sim, int i_low, int i_high,
...
void write_springs(reb_simulation *const n_body_sim, string fileroot, int index);
// Write particle info to file fileroot_%06d_particles.txt
void write_particles(reb_simulation *const n_body_sim, string fileroot, int index);
...
void write_heat(reb_simulation *const n_body_sim, string filename, int num_timesteps, double power_fac);
...
string heat_filename(reb_simulation *const n_body_sim, string root, double print_interval);
// Get filename for node file
string node_filename(reb_simulation *const n_body_sim, string root, double print_interval);
// Get filename for stress file
string stress_filename(reb_simulation *const n_body_sim, string root, double print_interval);
