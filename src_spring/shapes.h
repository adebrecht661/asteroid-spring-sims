...
double hcp_ellipsoid(struct reb_simulation *n_body_sim, double min_dist,
		double x, double y, double z, double total_mass);
// Create particles in cubic lattice inside ellipsoid of semi-axes x, y, z, no closer than min_dist, with total_mass
double cubic_ellipsoid(struct reb_simulation *n_body_sim, double min_dist,
		double x, double y, double z, double total_mass);
...
double min_radius(struct reb_simulation *n_body_sim, int i_low, int i_high);
// Return maximum distance from <0,0,0> in particle set [i_low, i_high)
double max_radius(struct reb_simulation *n_body_sim, int i_low, int i_high);
