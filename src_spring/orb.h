...
double add_bin_kep(struct reb_simulation *const n_body_sim, double m_prim, double r_prim,
...
void drift_bin(struct reb_simulation *const n_body_sim, double timestep, double inv_tau_a,
		double inv_tau_e, int part_1, int part_2);
// Drift orbits of particle and resolved body
void drift_resolved(struct reb_simulation *const n_body_sim, double timestep, double inv_tau_a,
...
void quadrupole_accel(struct reb_simulation *const n_body_sim, double J2_p, double R_p,
...
double sum_mass(struct reb_simulation *const n_body_sim, int i_low, int i_high);
