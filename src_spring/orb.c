...
double add_pluto_charon_kep(struct reb_simulation *const r, double mp,
		double mratio, double sep, double aa, double ee, double ii,
		double longnode, double argperi, double meananom, double r1) {
	// const int i1= r->N;
	// const int i2= i1+1;
...
double add_pt_mass_kep(struct reb_simulation *const r, int il, int ih, int ip,
		double m1, double r1, double aa, double ee, double ii, double longnode,
		double argperi, double meananom) {
	...
	if (ip < 0) {  // move position of extended body
		...
		pt.vx = 0.0;
		pt.vy = 0.0;
		pt.vz = 0.0; // new particle is at origin
...
double add_one_mass_kep(struct reb_simulation *const r, double m1, double aa,
		double ee, double ii, double longnode, double argperi, double meananom,
...
/////////////////////////////////////////////////////////////
void dodrift_bin(struct reb_simulation *const r, double tstep, double inv_taua,
		double inv_taue, int im1, int im2) {
	struct reb_particle *particles = r->particles;
...
/////////////////////////////////////////////////////////////
void dodrift_res(struct reb_simulation *const r, double tstep, double inv_taua,
		double inv_taue, int im1, int il, int ih) {
	struct reb_particle *particles = r->particles;
...
void add_one_mass_cartesian(struct reb_simulation *const r, double m1,
		double r1, double x, double y, double z, double vx, double vy,
		double vz) {
	struct reb_particle pt;
	pt.m = m1;
	pt.x = x;
...
void quadJ2pole(struct reb_simulation *const r, double J2p, double Rplusp,
		double phip, double thetap, int ic) {
	if (ic >= r->N)
		return;
	if (J2p == 0.0)
		return;
